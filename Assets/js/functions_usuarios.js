...
document.addEventListener('DOMContentLoaded', function(){
    //json para listar
    //tableUsuarios es el id de la tabla
    tableUsuarios = $('#tableUsuarios').dataTable( {
        ...
        "ajax":{
            //url que devuelve todos los datos
            "url": " "+base_url+"/Usuarios/getUsuarios",
            "dataSrc":""
        },
        "columns":[
            //estos nombres que se pone viene de getUsuarios cuando pones en la url y tiene que ser lo mismo
            {"data":"idpersona"},
            {"data":"nombres"},
            {"data":"apellidos"},
            {"data":"email_user"},
...
//falta revisar
//abrir model para ver datos de usuario
